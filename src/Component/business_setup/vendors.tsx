            ...
            <div className="p-6 bg-white rounded-lg shadow-md">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                        Complete the basic settings for vendors
                    </p>
                </div>
                ...
                <div className="bg-gray-50 grid grid-cols-1 md:grid-cols-2 gap-6 p-4 rounded-md">
                    ...
                    <div className="flex items-center justify-between p-4 bg-white rounded-md shadow-sm">
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-600 mt-1">
                                If enabled pos will be available on the vendor panel
                            </p>
                        </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-white rounded-md shadow-sm">
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-600 mt-1">
                                If enabled vendors can set minimum order amount for their vendors
                            </p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" className="   sr-only peer" />
                    ...
                    <div className="flex items-center justify-between p-4 bg-white rounded-md shadow-sm">
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-600 mt-1">
                                Enabling this option allows users to send requests to become registered
                            </p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" className="   sr-only peer" />
                    ...
                    <div className="flex items-center justify-between p-4 bg-white rounded-md shadow-sm">
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-600 mt-1">
                                Enable this option to allow vendors to reply to customer reviews
                            </p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" className="   sr-only peer" />
