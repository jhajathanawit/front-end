    ...
    return (
        <>
            <div className="mb-4 flex items-center p-2 mt-6 gap-2">
                <IoMdPerson className="text-2xl text-pink-500" />
            ...
            <div className="p-4 mt-5 shadow-md border rounded-md flex flex-col gap-4">
                ...
                <div className="flex">
                    ...
                    <div className="w-1/3 ml-2">
                        <h1 className="text-sm font-bold">Choose First</h1>
                        <input
                            type="number"
                            placeholder="Ex : 100"
                            className="text-gray-500 mt-2 w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-300"
                    ...
                    <div className="w-1/3 ml-2 flex items-end justify-start gap-4">
                        <button type="reset" className="w-1/2 py-2 border rounded bg-gray-100 text-black-600 hover:bg-gray-200">Reset</button>
                        <button type="submit" className="w-1/2 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                            Filter
                        </button>
                    </div>
                </div>
            ...
            <div className="p-4 mt-5 shadow-md border rounded-md flex flex-col gap-4">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-2">
                        <span className="font-semibold text-black">Customer list</span>
                    ...
                    <table className="mb-4 min-w-full table-auto">
                        <thead className="bg-gray-100">
                            <tr>
                                ...
                                <th className="px-10 py-2 font-semibold text-black whitespace-nowrap">Contact Info</th>
                                <th className="px-10 py-2 font-semibold text-black whitespace-nowrap">Total Order</th>
                                <th className="px-10 py-2 font-semibold text-black whitespace-nowrap">Block / Unblock</th>
