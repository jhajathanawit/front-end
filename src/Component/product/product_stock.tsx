        ...
        <>
            ...
            <div className="p-4 mt-5 shadow-md border rounded-md flex flex-col gap-4">
                <div className="flex">
                    ...
                    <div className="w-1/4 ml-2 mt-7">
                        <select className="mt-2 w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-300">
                            <option disabled selected>Stock sort by (low to high)</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        </select>
                    ...
                    <table className="mb-4 min-w-full table-auto">
                        <thead className="bg-gray-100">
                            <tr>
                                ...
                                <th className="text-left px-10 py-2 font-semibold text-black whitespace-nowrap">Last Updated Stock</th>
                                <th className="px-10 py-2 font-semibold text-black whitespace-nowrap">Current Stock</th>
